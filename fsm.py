...
class TocMachine(GraphMachine):
    ...
    def on_enter_start(self, event):
        ...
        btn_action=[
            MessageTemplateAction(
                label='Modified Personal Info',
                text='modified information'
            ),
            MessageTemplateAction(
                label='Check Breakfast/Lunch/Dinner Nutrition',
                text='check nutrition'
            ),
            MessageTemplateAction(
                label='Show Suggestion Nutrition',
        ...
        send_button_message(reply_token,btn_action,"Function List","Provide Below Services")
    ...
    def on_enter_checknutrition(self, event):
        btn_action=[
            ...
            MessageTemplateAction(
                label='Show Your Food\'s Nutrition',
                text='showeat'
            ),
        ]
        reply_token = event.reply_token
        send_button_message(reply_token,btn_action,"Choose Food","enter 1 to return")
    ...
    def on_enter_height(self, event):
        ...
        reply_token = event.reply_token
        send_text_message(reply_token, "Weight(kg) : ")
    #input the weight
    ...
    def on_enter_weight(self, event):
        ...
        print("in weight")
        reply_token = event.reply_token
        send_text_message(reply_token, "Budget(dollar) : ")
    ...
    def on_enter_money(self, event):
        ...
        print("in money")
        reply_token = event.reply_token
        send_text_message(reply_token, "Age : ")
    #input the age
